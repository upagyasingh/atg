...
export default function SignIn() {
  ...
  return (
    <React.Fragment>
      <p onClick={handleClickOpen} className="mt-3">Sign In</p>
      ...
      >
        ...
        <DialogContent dividers>
          <div className="grid grid-cols-2 ">
            ...
            <h3  className="mb-4 700:hidden">Sign In</h3>
            <h3  className="mb-4 700:flex hidden">Welcome Back !</h3>
            <div className="grid grid-cols-2">
               ...
               <button className="w-full bg-blue-700 text-white rounded-full h-12 mt-3 700:p-3 ">Sign In</button>
               </div>
               <div className=" hidden 700:flex"><a href="#" className="text-slate-500 hover:text-blue-700">Or, Create Account</a></div>
               </div>
               ...
               <div className="col-span-2 px-3 mt-3">
                ...
                <p className="flex justify-center mt-3 "><b>Forgot Password ?</b></p>
               </div>
               
              </div>
            </div>
            <div className="700:hidden">
                <h6 className="text-slate-600 flex justify-end ">Don’t have an account yet!&nbsp; <b className="text-blue-700 cursor-pointer">  Create new for free </b></h6>
